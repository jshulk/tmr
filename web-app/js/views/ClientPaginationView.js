...
/*
* Idea - we will keep both Paginationview and the WatchedFundList view
* configurable via "clientSide" parameter.
* We will trigger a "paginated" event and pass the sliced collection
* from the pagination view on the collection
* whenever we click on next or other nav links.
* Fund List view will listen to this "paginated" event and will rerender itself
* by removing existing views and rendering the views for the next set of models.
*/
